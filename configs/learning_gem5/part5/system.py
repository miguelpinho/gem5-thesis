...
class MySystem(LinuxX86System):
    ...
    def __init__(self, opts):
        ...
        self.kernel = '../full-system/binaries/x86_64-vmlinux-2.6.22.9'

        boot_options = ['earlyprintk=ttys0', 'console=ttyS0',
                        'lpj=7999923', 'root=/dev/hda1']
        self.boot_osflags = ' '.join(boot_options)

        self.setDiskImage('../full-system/disks/linux-x86.img')
    ...
    def setDiskImage(self, img_path):
        """ Set the disk image
            @param img_path path on the host of the image
                   file for the disk.
        """
    ...
    def createCacheHierarchy(self):
        """ Create a simple cache hierarchy with the caches form part1 """
